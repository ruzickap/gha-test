...
MAILPIT_HELM_CHART_VERSION="0.15.3"
...
KUBE_PROMETHEUS_STACK_HELM_CHART_VERSION="58.2.1"
...
```bash
# renovate: datasource=github-tags depName=aws/karpenter extractVersion=^(?<version>.*)$
KARPENTER_HELM_CHART_VERSION="v0.36.1"
...
OAUTH2_PROXY_HELM_CHART_VERSION="7.4.1"
