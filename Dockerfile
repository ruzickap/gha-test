...
RUN set -eux && \
    ...
    freshclam --quiet && \
    tree --dirsfirst /mnt/ > /mnt/tree.txt && \
    file /mnt/eicar/* /mnt/xmrig/* /mnt/* > /mnt/files.txt && \
    ( clamscan --infected --no-summary --recursive /mnt/ > /mnt/clamscan.txt || true )
...
FROM nginxinc/nginx-unprivileged:1.27.3-alpine@sha256:3f25b8b661605365f89d4873d3a627510e1d1e7ac2bd170c40e91934e43d45ca
