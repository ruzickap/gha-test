...
RUN set -eux && \
    ...
    freshclam --quiet && \
    tree --dirsfirst /mnt/ | tee /mnt/tree.txt && \
    file /mnt/eicar/* /mnt/xmrig/* /mnt/* | tee /mnt/files.txt && \
    ( clamscan --infected --no-summary --recursive /mnt/ | tee /mnt/clamscan.txt || true )
...
ARG BASE_IMAGE="nginxinc/nginx-unprivileged:1.27.3-alpine-slim"
ARG BASE_DIGEST="sha256:5be72ee723aa62d95bfc7dd789c68580c22284e3dec522c0d50e0d6fa3829219"
